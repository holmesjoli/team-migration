...
<BigButterflyContainer bind:selectedCountry={selectedCountry} warnings={datasets[4]} definitions={datasets[5]} questions={datasets[6]} acqMode={datasets[7]} butterflies={butterflies}/>